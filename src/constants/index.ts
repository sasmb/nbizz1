...
export const pricingCards = [
    {
        title: " Per Lead ",
        description: "Perfect to see the power of your new website.",
        price: "$19/lead",
        duration: "",
        highlight: "Key features",
        buttonText: "Pay Per Lead",
        features: [
            ...
            "Send leads to your CRM or phone",
    ...
    {
        title: "Per Month",
        description: "To get unlimited leads and all the features of the platform.",
        price: "$99/month",
        duration: "month",
        highlight: "Key features",
        buttonText: "Pay Per Month",
        features: [
            "Bring your custom domain name",
            "Lifetime updates",
            "Search engine optimized",
    ...
    {
        title: "One-time",
        description: "Buy the website outright and never pay again.",
