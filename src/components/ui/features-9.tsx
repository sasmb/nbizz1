            ...
            <div className="mx-auto grid max-w-5xl border md:grid-cols-2">
                <div>
                    <div className="p-6 sm:p-12">
                        ...
                        <p className="mt-8 text-2xl font-semibold">Scalable e-commerce with MedusaJS, Instantly deploy powerful storefronts.</p>
                    </div>
                    ...
                    <div aria-hidden className="relative">
                        <div className="absolute inset-0 z-10 m-auto size-fit">
                            <div className="rounded-[--radius] bg-background z-[1] dark:bg-muted relative flex size-fit w-fit items-center gap-2 border px-3 py-1 text-xs font-medium shadow-md shadow-black/5">
                                <span className="text-lg">🛒</span> Last order from New York
                            </div>
                ...
                <div className="overflow-hidden border-t bg-zinc-50 p-6 sm:p-12 md:border-0 md:border-l dark:bg-transparent">
                    <div className="relative z-10">
                        ...
                        <p className="my-8 text-2xl font-semibold">Secure payments with Stripe, Paystack, and more for global reach.</p>
                    </div>
                    <div aria-hidden className="flex flex-col gap-8">
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-muted-foreground text-xs">Payment received</span>
                            </div>
                            <div className="rounded-[--radius] bg-background mt-1.5 w-3/5 border p-3 text-xs">Customer paid $129.99 via Stripe</div>
                        </div>

                        <div>
                            <div className="rounded-[--radius] mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">Order confirmed and inventory updated automatically.</div>
