                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=3276&h=4095&fit=crop&crop=center"
                                alt="Modern business storefront background"
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src="/images/Screenshot 2025-07-16 at 09.18.05.png"
                                        alt="Reech platform dashboard preview"
                                        width="2700"
                                        height="1440"
                                    />
                                </div>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex">
                                <div className="mx-auto h-5 w-fit flex items-center text-sm font-medium text-muted-foreground">
                                    Shopify
                                </div>
                            </div>
                            <div className="flex">
...
const ReechLogo = ({ className }: { className?: string }) => {
    return (
