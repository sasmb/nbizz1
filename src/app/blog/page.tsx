...
const categories = [
  { id: 'all', name: 'All', count: 4 },
  { id: 'ai-technology', name: 'AI & Technology', count: 2 },
  { id: 'business-automation', name: 'Business Automation', count: 1 },
  { id: 'african-ecommerce', name: 'African E-commerce', count: 1 },
  { id: 'platform-comparison', name: 'Platform Comparison', count: 1 }
]
  ...
  const filteredPosts = selectedCategory === 'all' 
    ...
    : blogPosts.filter(post => {
        const categoryMap: { [key: string]: string } = {
          ...
          'african-ecommerce': 'African E-commerce',
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-full font-medium transition-all ${
                    selectedCategory === category.id
                      ...
                      : 'bg-white hover:bg-gray-100 text-gray-700 hover:text-gray-900 border border-gray-200 shadow-sm'
                  }`}
                >
                  {category.name}
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {filteredPosts.map((post) => (
                <Link key={post.id} href={`/blog/${post.id}`}>
                  <Card className="overflow-hidden hover:shadow-xl hover:scale-[1.02] transition-all duration-300 cursor-pointer group bg-white border border-gray-200">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex gap-1">
                          {post.tags.slice(0, 2).map((tag) => (
                            <Badge key={tag} variant="outline" className="text-xs px-2 py-1 border-gray-200 text-gray-600">
                              {tag}
                            </Badge>
                          ))}
                        </div>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-8">
                Get the latest insights on AI automation and e-commerce trends delivered to your inbox.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-4 py-2 border border-gray-300 rounded-md bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
