                ...
                <Container>
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            ...
                            AI-powered Agents, Automate Your Bizz
                            </h1>
                            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                                Multi-lingual Smart bot, automate follow-ups, and close more deals while your team focuses on what matters most
                            </p>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        Start closing more deals in three steps
                        </h2>
                        <p className="text-muted-foreground mt-6">
                        Get your sales team powered by NBizz in minutes
                        </p>
                    </div>
                </Container>
                <Container>
...
<Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            NBizz gives your team the tools to convert more leads into happy customers
                        </p>
                    </div>
                </Container>
                <Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            Grow your sales without growing your costs
                        </p>
                    </div>
                </Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            See how sales teams are crushing their targets with NBizz
                        </p>
                    </div>
                </Container>
                <Container>
                    ...
                    <LampContainer>
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            <h2 className="text-4xl lg:text-5xl xl:text-6xl lg:!leading-snug font-semibold mt-8">
                                From First Contact to <br /> Closed Deal
                            </h2>
                            <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                                Join sales teams already closing more deals with NBizz
                            </p>
